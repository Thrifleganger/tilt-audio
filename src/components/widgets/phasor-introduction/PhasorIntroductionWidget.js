...
const PhasorIntroductionWidget = ({match}) => {
  ...
  const sketch = (p) => {
    p.setup = () => {
      ...
      unitCircle2 = new UnitCircle(p, {x: w/6, y: 3*h/8}, radius, 6, p.color(250), p.color(255, 181, 181));
      unitCircle3 = new AdditiveUnitCircle(p, {x: w/6, y: 3*h/4}, radius, 6, p.color(250), p.color(255, 251, 194));
      sineWave1 = new SinusoidFollower(p, {x: w/3, y: h/8}, 6, radius, 0.0, p.color(194, 245, 255), false);
      sineWave2 = new SinusoidFollower(p, {x: w/3, y: 3*h/8}, 6, radius, 0.0, p.color(255, 181, 181), false);
...
export default PhasorIntroductionWidget;